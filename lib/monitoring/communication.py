...
class DeliverNscaweb(threading.Thread):
	def __init__(self,location=None,data=None,username=None,password=None,size=None,queue_size=None,queue_bytes='0',logging=None,key_file=None,cert_file=None,ca_certs=None):
		threading.Thread.__init__(self)
		self.location=location
		self.data=data
		...
		self.logging=logging
		self.status=False
		self.opener = urllib2.build_opener(httpsclientauth.HTTPSClientAuthHandler(key_file=key_file, cert_file=cert_file, ca_certs=ca_certs))
...
class DeliverNrdp(threading.Thread):
	def __init__(self,location=None,data=None,username=None,password=None,token=None,size=None,queue_size=None,queue_bytes='0',logging=None,key_file=None,cert_file=None,ca_certs=None):
		threading.Thread.__init__(self)
		self.location=location
		self.data=data
		self.username=username
